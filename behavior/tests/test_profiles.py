...
class TestFeatureGeneration:
    ...
    def test_velocity_features(self):
        ...
        from behavior.feature_generation.velocity import compute_velocity_features_from_profile
        
        # Mock customer profile
        profile = Mock()
        profile.velocity_windows = {
            "1m": type('obj', (object,), {'count': 5, 'total_amt': 1000.0, 'mean_amt': 200.0}),
            "1h": type('obj', (object,), {'count': 20, 'total_amt': 5000.0, 'mean_amt': 250.0}),
"24h": type('obj', (object,), {'count': 50, 'total_amt': 20000.0, 'mean_amt': 400.0}),
        }
    ...
    def test_trust_scoring(self):
        ...
        profile.get_device_trust_score = Mock(side_effect=lambda d: 1.0 if d in {"dev_1", "dev_2"} else 0.5)
    ...
    def test_novelty_detection(self):
        ...
        from behavior.feature_generation.novelty import (
            get_new_device_flag, get_new_merchant_flag, get_new_country_flag
        )
