...
class MerchantBehaviorProfile:
    ...
    # Amount statistics
    amount_stats: object = field(default_factory=lambda: OnlineMeanVariance())  # OnlineMeanVariance
    ...
    def get_risk_score(self) -> float:
        ...
        if self.total_transactions > 10 and self.unique_customers > 0:
            new_customer_ratio = len([c for c in self.customer_frequency.values() if c == 1]) / self.unique_customers
