...
async def admin_health():
    ...
    try:
        ch = Client(
            ...
            database=s.clickhouse_database, user=s.clickhouse_user,
    ...
    return {
        "rules": {
            ...
            "by_type": {
                ...
                for t in [RuleType.BLOCKLIST, RuleType.THRESHOLD, RuleType.EXPRESSION, RuleType.VELOCITY, RuleType.GEO]
            },
        },
        "blocklists": {
