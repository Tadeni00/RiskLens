        ...
        rows.append(
            {
                ...
                "decision": (
                    ...
                    else "REVIEW" if rng.random() > 0.85 else "APPROVE"
                ),
...
def make_shap_values(n_samples: int = 200) -> pd.DataFrame:
    ...
    for _ in range(n_samples):
        ...
        for feat in features:
            base = {
                "acct_v_1h_count": 0.18,
                "amount_zscore": 0.15,
                "is_new_device": 0.12,
                "impossible_travel": 0.10,
                "geo_speed_kmh": 0.09,
                "typing_zscore": 0.08,
                "acct_v_24h_total_amt": 0.07,
                "device_account_count": 0.06,
            }
...
def make_live_timeseries(
    hours: int = 24, tenant_id: str = "all_tenants"
